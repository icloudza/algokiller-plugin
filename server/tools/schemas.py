...
TOOLS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "Use this to identify which modules bridge to which (e.g. app_main <-> lib_net) "
    ...
    },
    {
        ...
        "description": (
            ...
            "the minimum number of block repetitions required before collapsing. Real production "
